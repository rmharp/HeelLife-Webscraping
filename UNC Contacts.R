...
if(!require(tidyverse)) {install.packages("dplyr"); library(tidyverse)}
if(!require(rvest)) {install.packages("dplyr"); library(rvest)}
if(!require(RSelenium)) {install.packages("dplyr"); library(RSelenium)}
if(!require(wdman)) {install.packages("dplyr"); library(wdman)}
if(!require(netstat)) {install.packages("dplyr"); library(netstat)}
if(!require(xml2)) {install.packages("dplyr"); library(xml2)}
if(!require(webdriver)) {install.packages("dplyr"); library(webdriver)}
if(!require(purrr)) {install.packages("dplyr"); library(purrr)}
